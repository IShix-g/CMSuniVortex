...
{
    public abstract class ExcelCuvOutput<TModel, TModelList, TReference> : CuvOutput<TModel, TModelList, TReference>
        where TModel : ExcelModel
        where TModelList : ExcelCuvModelList<TModel>
        where TReference : ExcelCuvReference<TModel, TModelList>
    {
