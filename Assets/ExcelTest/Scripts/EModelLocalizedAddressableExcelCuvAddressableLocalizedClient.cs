...
namespace Test
{
    ...
    public sealed class EModelLocalizedAddressableExcelCuvAddressableLocalizedClient : ExcelCuvAddressableLocalizedClient<EModelLocalizedAddressable, EModelLocalizedAddressableExcelCuvModelList> {}
}