...
namespace Test
{
    ...
    public sealed class EModelAddressableExcelCuvAddressableOutput : ExcelCuvAddressableOutput<EModelAddressable, EModelAddressableExcelCuvModelList, EModelAddressableExcelCuvAddressableReference> {}
}