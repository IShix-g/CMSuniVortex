...
namespace Test
{
    ...
    public sealed class MetaCustomGoogleSheetCuvOutput : CustomGoogleSheetCuvOutput<Meta, MetaCustomGoogleSheetCuvModelList, MetaCustomGoogleSheetCuvReference> {}
}